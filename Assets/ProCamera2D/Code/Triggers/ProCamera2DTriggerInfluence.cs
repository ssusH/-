...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    public class ProCamera2DTriggerInfluence : BaseTrigger
    {
        ...
        IEnumerator InsideTriggerRoutine()
        {
            ...
            while (_insideTrigger)
            {
                ...
                else
                {
                    ...
                    _influence = Vector2.SmoothDamp(_influence, -vectorFromPointToFocus * (1 - distancePercentage), ref _velocity, InfluenceSmoothness,0,0);
                    ProCamera2D.ApplyInfluence(_influence);
        ...
        IEnumerator OutsideTriggerRoutine()
        {
            ...
            {
                _influence = Vector2.SmoothDamp(_influence, Vector2.zero, ref _velocity, InfluenceSmoothness,0,0);
                ProCamera2D.ApplyInfluence(_influence);
